...
class NodeDefinition(google.protobuf.message.Message):
    ...
    class InputDef(google.protobuf.message.Message):
        ...
        @property
        def spec(self) -> custom_struct.v1_pb2.CustomStruct: ...
        def __init__(
            self,
            *,
            display_name: builtins.str = ...,
            edge_type: builtins.str = ...,
            spec: custom_struct.v1_pb2.CustomStruct | None = ...,
            required: builtins.bool = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["spec", b"spec"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["display_name", b"display_name", "edge_type", b"edge_type", "required", b"required", "spec", b"spec"]) -> None: ...
    ...
    class OutputDef(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["display_name", b"display_name", "edge_type", b"edge_type"]) -> None: ...
    ...
    class InputsEntry(google.protobuf.message.Message):
        ...
        key: builtins.str
        @property
        def value(self) -> global___NodeDefinition.InputDef: ...
        def __init__(
            self,
            *,
            key: builtins.str = ...,
            value: global___NodeDefinition.InputDef | None = ...,
        ) -> None: ...
    ...
    class OutputsEntry(google.protobuf.message.Message):
        ...
        key: builtins.str
        @property
        def value(self) -> global___NodeDefinition.OutputDef: ...
        def __init__(
            self,
            *,
            key: builtins.str = ...,
            value: global___NodeDefinition.OutputDef | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["value", b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["key", b"key", "value", b"value"]) -> None: ...
    ...
    """e.g., "latent/inpaint" """
    @property
    def inputs(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___NodeDefinition.InputDef]:
        """Keys are the identifier for this node, i.e., "node_name.output_name" for an output_ref
        or "node_name.inputs.input_name" in the serialized workflow
        """

    @property
    def outputs(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___NodeDefinition.OutputDef]: ...
    @property
    def ux_widgets(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        """e.g., "core.image", "core.run" """
    ...
    def __init__(
        ...
        *,
        ...
        description: builtins.str = ...,
        category: builtins.str = ...,
        inputs: collections.abc.Mapping[builtins.str, global___NodeDefinition.InputDef] | None = ...,
        outputs: collections.abc.Mapping[builtins.str, global___NodeDefinition.OutputDef] | None = ...,
        ux_widgets: collections.abc.Iterable[builtins.str] | None = ...,
    ) -> None: ...
